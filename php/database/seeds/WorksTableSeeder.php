...
class WorksTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('works')->insert([
            ...
            'url' => "http://pduinc.com",
            'name' => "pduinc",
            'details' => "Redesigned site from the ground up, Added Product Catalog and Product Search powered by external C# codebase.",
        ]);

        DB::table('works')->insert([
            'id' => 10,
            'url' => "http://alpineindustrialmfg.com",
            'name' => "alpineindustrialmfg",
            'details' => "Redesigned site from the ground up, Created as a connecting point to other related company websites.",
        ]);
    }
}
